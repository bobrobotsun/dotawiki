...
edit_adition = {
    ...
    '物品属性': {
        ...
        '百分比力量': {'代码': 'strength_pct', '后缀': '%', '展示前缀': '+', '展示后缀': '[[file:Agility_Icon.png|24px]][[敏捷]]'},
        '敏捷': {'代码': 'bonus_agility', '后缀': '', '展示前缀': '+', '展示后缀': '[[file:Agility_Icon.png|24px]][[敏捷]]'},
        '百分比敏捷': {'代码': 'agility_pct', '后缀': '%', '展示前缀': '+', '展示后缀': '[[file:Agility_Icon.png|24px]][[敏捷]]'},
        '智力': {'代码': 'bonus_intellect', '后缀': '', '展示前缀': '+', '展示后缀': '[[file:Intelligence_Icon.png|24px]][[智力]]'},
        '百分比智力': {'代码': 'intelligence_pct', '后缀': '%', '展示前缀': '+', '展示后缀': '[[file:Intelligence_Icon.png|24px]][[智力]]'},
