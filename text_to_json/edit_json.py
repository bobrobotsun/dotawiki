...
edit = {
    ...
    '技能源': {
        ...
        "减益免疫": ['tree', {"list": ['tree', {'代码': ['int', 0], '简述': ['text', '']}, 1, 0, True]}],
...
edit_adition = {
    ...
    '物品属性': {
        ...
        '百分比主属性': {'代码': 'primary_stat_percent', '后缀': '%', '展示前缀': '+', '展示后缀': '[[属性|主属性]]'},
        '次级属性': {'代码': 'secondary_stats', '后缀': '', '展示前缀': '+', '展示后缀': '[[属性|次级属性]]'},
        '力量': {'代码': 'bonus_strength', '后缀': '', '展示前缀': '+', '展示后缀': '{{hai|力量}}'},
        '百分比力量': {'代码': 'strength_pct', '后缀': '%', '展示前缀': '+', '展示后缀': '{{hai|敏捷}}'},
        '敏捷': {'代码': 'bonus_agility', '后缀': '', '展示前缀': '+', '展示后缀': '{{hai|敏捷}}'},
        '百分比敏捷': {'代码': 'agility_pct', '后缀': '%', '展示前缀': '+', '展示后缀': '{{hai|敏捷}}'},
        '智力': {'代码': 'bonus_intellect', '后缀': '', '展示前缀': '+', '展示后缀': '{{hai|智力}}'},
        '百分比智力': {'代码': 'intelligence_pct', '后缀': '%', '展示前缀': '+', '展示后缀': '{{hai|智力}}'},
        '生命值': {'代码': 'bonus_health', '后缀': '', '展示前缀': '+', '展示后缀': '[[生命值]]'},
        '魔法值': {'代码': 'bonus_mana', '后缀': '', '展示前缀': '+', '展示后缀': '[[魔法值]]'},
        '负魔法值': {'代码': 'bonus_mana', '后缀': '', '展示前缀': '-', '展示后缀': '[[魔法值]]'},
        '生命恢复': {'代码': 'bonus_health_regen', '后缀': '', '展示前缀': '+', '展示后缀': '[[生命恢复速率]]'},
        ...
        '远程攻击距离': {'代码': 'range_attack_range', '后缀': '', '展示前缀': '+', '展示后缀': '[[攻击距离]]（远程）'},
        '施法距离': {'代码': 'cast_range_bonus', '后缀': '', '展示前缀': '+', '展示后缀': '[[施法距离]]'},
        '攻击吸血': {'代码': 'lifesteal_percent', '后缀': '%', '展示前缀': '+', '展示后缀': '[[攻击吸血]]'},
        '技能吸血': {'代码': 'spell_lifesteal', '后缀': '%', '展示前缀': '+', '展示后缀': '[[技能吸血]]'},
        '英雄技能吸血': {'代码': 'hero_lifesteal', '后缀': '%', '展示前缀': '+', '展示后缀': '[[技能吸血]]（英雄）'},
        '非英雄技能吸血': {'代码': 'creep_lifesteal', '后缀': '%', '展示前缀': '+', '展示后缀': '[[技能吸血]]（非英雄）'},
        ...
        '百分比前摇攻击速度': {'代码': 'anim_increase', '后缀': '%', '展示前缀': '+', '展示后缀': '攻击前摇期间[[攻击速度]]'},
        ...
        '状态抗性降低': {'代码': 'status_resistance', '后缀': '%', '展示前缀': '+', '展示后缀': '[[状态抗性]]降低'},
